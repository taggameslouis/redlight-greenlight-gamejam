...
namespace Quantum
{
    public unsafe class SoccerAIHelper
    {
        public static FPVector2 GetTargetPosition(Frame f, FPVector2 initialPosition, FPVector2 direction, int team)
        {
            ...
            var offset = ballPosition.X;
            if (direction != FPVector2.Zero) offset = direction.X * (int)ballPosition.X;
        ...
        public static void MoveCondition(Frame f, EntityRef character, FPVector2 position, FPVector2 target,
            FP maxDistance)
        {
